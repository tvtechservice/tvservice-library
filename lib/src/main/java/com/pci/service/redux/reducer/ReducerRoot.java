...
//            put(PCI_AGREE_MIC_USE, new ReducerAgreeMicUse());
//            put(PCI_DISAGREE_MIC_USE, new ReducerDisagreeMicUse());
            put(PCI_CHECKIN_LIST, new ReducerCheckinList());
            put(PCI_DMR_CHECKIN, new ReducerDMRCheckin());
        }});
