            ...
            try {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (response.getData() != null) {
                        PCILog.d(gson.toJson(response.getData()));   // data 응답
                    }
...
//                responseEntity.setStatus(responseHolder.getStatus());
//                PCILog.d("Response Payload     : %s", gson.toJson(responseHolder.getData(responseDataClass)));
